...
podremos salir a la calle: el hecho de tener que ir a la biblioteca.
...
public class Ejercicio13 {
	public static void main(String[] args) {
		...
		if((lloviendo==false && tareas==true)||biblioteca==true) {
			salida = true;
		}
		System.out.println("\nPuedes ir a la calle: "+salida);
		sc.close();
